...
#define light_state_topic "cyfi/sensornode2"
#define light_set_topic "cyfi/sensornode2/set"
...
/**************************** FOR OTA **************************************************/
#define OTApassword "codeBASS" // change this to whatever password you want to use when you upload OTA
int OTAport = 8266;
...
void sendState() {
  ...
  if(celsius) {
    root["heatIndex"] = (String)(calculateHeatIndex(humValue, tempValue)+3);
  } else {
